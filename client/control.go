...
// connectServer return a new connection to server
func (ctl *Control) connectServer() (conn net.Conn, err error) {
	return ctl.cm.Connect()
}

// reader read all messages from server and send to readCh
...
// writer writes messages got from sendCh to server
...
func (ctl *Control) msgHandler() {
	...
	// Just keep it here to keep compatible with old version server.
