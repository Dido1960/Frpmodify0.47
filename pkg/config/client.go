...
type ClientCommonConf struct {
	...
	// DialServerKeepAlive specifies the interval between keep-alive probes for an active network connection between client and server.
	...
	// DNSServer specifies a DNS server address for TOOLC to use. If this value
	...
	// By default, client will connect server with first custom byte if tls is enabled.
	// If DisableCustomTLSFirstByte is true, client will not send that custom byte.
