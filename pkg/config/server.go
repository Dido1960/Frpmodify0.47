// Copyright 2020 The tool Authors
//
...
type ServerCommonConf struct {
	...
	// If TCPMuxPassthrough is true, server won't do any update on traffic.
	...
	// debug info) to client. By default, this value is true.
	DetailedErrorsToClient bool `ini:"detailed_errors_to_client" json:"detailed_errors_to_client"`

	// SubDomainHost specifies the domain that will be attached to sub-domains
	// requested by the client when using Vhost proxying. For example, if this
	// value is set to "server.com" and the client requested the subdomain
	// "test", the resulting URL would be "test.server.com". By default, this
	// value is "".
	...
	// TCPKeepAlive specifies the interval between keep-alive probes for an active network connection between client and server.
	...
	// change:企业微信机器人
	BOTKey   string `ini:"bot_key" json:"bot_key"`
