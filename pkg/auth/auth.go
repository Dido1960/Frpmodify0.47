...
type BaseConfig struct {
	...
	// authenticate client with server. If "token" is specified - token will be
	...
	// heartbeats sent to server. By default, this value is false.
	...
	// new work connections sent to server. By default, this value is false.
